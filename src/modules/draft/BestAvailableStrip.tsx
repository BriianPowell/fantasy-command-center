...
export function BestAvailableStrip({ recommendations }: { recommendations: DraftRecommendation[] }) {
  if (!recommendations.length) {
    return null;
  }

  return (
    <section className="best-available-strip" aria-label="Best available players">
      <div>
      ...
      <div className="best-available-list">
        {recommendations.map((recommendation, index) => {
          const primaryPosition = getPrimaryPosition(recommendation.player.positions);
