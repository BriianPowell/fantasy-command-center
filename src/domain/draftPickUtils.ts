...
export function sortDraftPicks(picks: DraftPick[], order: DraftPickDisplayOrder = "oldest_first"): DraftPick[] {
  return [...picks].sort((a, b) => (order === "oldest_first" ? a.pickNo - b.pickNo : b.pickNo - a.pickNo));
}
